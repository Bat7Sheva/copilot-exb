      ...
      <div className='data-container surface-2 p-4'>
...

        {
          ...
          <div className='big-done-btn w-100'>
            <Button onClick={onFinish} disabled={isLoading} type='primary' className='text-truncate w-100 done-btn' title={translate('done')} aria-label={translate('done')}>
              {translate('done')}
            </Button>
          </div>
        }
...
const style = css`
  .data-container {
    ...
    .small-done-btn>button:hover { // geonet
      color: rgb(255, 255, 255);
    }
  }
    .done-btn: hover { // geonet
      color: var(--white) !important;  // geonet
  }
`

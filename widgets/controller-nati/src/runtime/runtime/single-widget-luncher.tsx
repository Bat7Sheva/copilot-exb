...
// import { HeaderTitleWithButton } from '../../../../shared-code/common-components/header-title-with-button'
...
//         // headerTitle={title}
//           headerTitle={<HeaderTitleWithButton title={title} onMyClick={()=> {alert("😊😊😊")}} />} // ⬅️ כאן
